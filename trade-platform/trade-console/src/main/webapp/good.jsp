...
<body>
	<!-- first page -->
	<div class="container-fluid" style="display: block;" id="items">
		<!-- <div class="span4">
			<h3 class="text-center">标题</h3>
			<img alt="140x140"
				src="https://timgsa.baidu.com/timg?image&amp;quality=80&amp;size=b9999_10000&amp;sec=1493286219740&amp;di=7b60ec6c434cbf55ea7bb65c7387d6a0&amp;imgtype=0&amp;src=http%3A%2F%2Fimg2.niushe.com%2Fupload%2F201304%2F19%2F14-22-31-71-26144.jpg">
			<p>
				<em>详情</em>
			</p>
			<button class="btn btn-info btn-large btn-block" type="button">
				<span>购买</span>
			</button>
		</div>
		<div class="span4">
				...
				success:function(result){
					if(result.errorcode=='SUCCESS'){
						for(var i=0;i<result.data.length;i++){
							...
							"</p>"+
							"<button class='btn btn-info btn-large btn-block' type='button'>"+
								"<span><a href='trade/"+data.itemId+"'>购买</a></span>"+
							"</button>"+
						"</div>"
