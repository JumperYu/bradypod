...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="row-fluid">
                <div class="span6">
                    <img id="url" lt="140x140" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1493286219740&di=7b60ec6c434cbf55ea7bb65c7387d6a0&imgtype=0&src=http%3A%2F%2Fimg2.niushe.com%2Fupload%2F201304%2F19%2F14-22-31-71-26144.jpg" />
                </div>
                <div class="span6">
            ...
            <form style="text-align: center" class="form-inline">
                <fieldset>
                    <label>数量:</label><input name="num" type="text" />
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="btn-group">
                <button class="btn">东莞市莞城11101110号</button> <button data-toggle="dropdown" class="btn dropdown-toggle"><span class="caret"></span></button>
        ...
        <div class="span12">
            ...
            <div class="row-fluid">
                ...
                <div class="span4">
                    ...
                    <button id="submit2" class="btn btn-large btn-block btn-danger" type="button">确认订单</button>
                </div>
            </div>
        </div>
    </div>
...
<script id="tpl1" type="text/template">
    ...
    <div class="span4">
        <h3 class="text-center">
           <@ this[index]['title'] @>
        </h3><img alt="140x140" src="<@ this[index]['url'] @>" />
        <p>
            <em><@ this[index]['info'] @></em>
        </p> <button class="btn btn-info btn-large btn-block" type="button"><span>查看详情</span></button>
    </div>
    <@ } @>
</script>
...
<script>
    ...
    var list = [
        {
            title:"Life is short,I need python",
            info:"php是世界上最好的语言,php是世界上最好的语言,php是世界上最好的语言,php是世界上最好的语言",
            url:"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1493286219740&di=7b60ec6c434cbf55ea7bb65c7387d6a0&imgtype=0&src=http%3A%2F%2Fimg2.niushe.com%2Fupload%2F201304%2F19%2F14-22-31-71-26144.jpg"
        },{
            title:"Life is long,I dont need php",
            info:"php是世界上最好的语言,php是世界上最好的语言,php是世界上最好的语言,php是世界上最好的语言",
            url:"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1493286219740&di=7b60ec6c434cbf55ea7bb65c7387d6a0&imgtype=0&src=http%3A%2F%2Fimg2.niushe.com%2Fupload%2F201304%2F19%2F14-22-31-71-26144.jpg"
        }
    ];
    ...
    window.onload = function () {
        ...
        $(items).eq(0).html(Util.tpl($('#tpl1').html(),list));
        var curObj;
        var buttons = $(items).eq(0).find('button');
        for(var i=0;i<buttons.length;i++){
            (function (i) {
                $(buttons).eq(i).click(function () {
                    var obj = list[i];
                    location.hash = "#detail";
                    $(items).eq(1).find('#title').html(obj.title);
                    $(items).eq(1).find('#url').html(obj.url);
                    $(items).eq(1).find('#info').html(obj.info);
                    curObj = obj;
        ...
        $('#submit').click(function () {
            location.hash = '#car';
            var obj = curObj;
            $(items).eq(2).find('#itemTitle').html(obj.title);
            $(items).eq(2).find('#url').attr("src",obj.url);
            $(items).eq(2).find('#itemDate').html(new Date);
            $(items).eq(2).find('#info').html(obj.info);
            return false;
        });
