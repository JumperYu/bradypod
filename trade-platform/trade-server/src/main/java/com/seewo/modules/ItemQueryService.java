...
public class ItemQueryService {
	...
	public ItemQueryService() {
		Item item1 = new Item(1L, "iphone-9-plus", 100, 10000000, 10, "1001",
				"https://store.storeimages.cdn-apple.com/8749/as-images.apple.com/is/image/AppleInc/aos/published/images/i/ph/iphone7plus/model/iphone7plus-model-select-201703_GEO_CN?wid=464&hei=662&fmt=png-alpha&qlt=95&.v=1488499908408",
				"iphone-9-plus新品售卖，限购两件");
		Item item2 = new Item(2L, "TECHDAY 1元秒杀", 200, 10000000, 10, "1002",
				"http://cms-bucket.nosdn.127.net/c71101528b094e47b0e3a9a021e9e40020160909210731.png?imageView&thumbnail=550x0",
				"TECHDAY 1元秒杀活动，限购一件，逢秒数10的倍数开抢");
		Item item3 = new Item(3L, "MAXHUB", 300, 10000000, 30, "1003",
				"http://www.maxhub.vip/static/images/items/productlist/img_product_c-26d0d104ba.png",
				"MAXHUB大促销，前10名下单5折优惠，剩余订单8折优惠");
		Item item4 = new Item(4L, "帅气的衣服", 400, 10000000, 20, "1004",
