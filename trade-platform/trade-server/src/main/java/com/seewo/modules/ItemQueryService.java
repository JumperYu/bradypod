...
public class ItemQueryService {
	...
	public ItemQueryService() {
		...
		Item item2 = new Item(2L, "TECHDAY 1元秒杀", 200, 10000000,10, "1002","http://cms-bucket.nosdn.127.net/c71101528b094e47b0e3a9a021e9e40020160909210731.png?imageView&thumbnail=550x0","TECHDAY 1元秒杀活动，限购一件，逢秒数10的倍数开抢");
		Item item3 = new Item(3L, "MAXHUB", 300, 10000000,30, "1003","http://www.maxhub.vip/static/images/items/productlist/img_product_c-26d0d104ba.png","MAXHUB大促销，前10名下单5折优惠，剩余订单8折优惠");
		Item item4 = new Item(4L, "帅气的衣服", 400, 10000000,20, "1004","https://g-search3.alicdn.com/img/bao/uploaded/i4/i4/751306283/TB2DJzhoFXXXXXsXpXXXXXXXXXX_!!751306283.jpg_460x460Q90.jpg_.webp","帅气的衣服，买两件7折优惠");
		Item item5 = new Item(5L, "鲜花", 500, 10000000,20, "1005","https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=2565682480,1049014799&fm=23&gp=0.jpg","鲜花，满两件包邮，免运费");
