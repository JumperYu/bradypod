...
/*		entity.createJavaFile("item_center.t_ctg_info", "CategoryInfo",
				"zengxm", "com.yu.shop.item.center",
				System.getProperty("user.dir") + "\\src\\main\\java\\");
		entity.createJavaFile("item_center.t_ctg_attri", "CategoryAttri",
				"zengxm", "com.yu.shop.item.center",
				System.getProperty("user.dir") + "\\src\\main\\java\\");*/
		entity.createJavaFile("item_center.t_dict_sys", "Dictionary",
				"zengxm", "com.yu.shop.item.center",
				System.getProperty("user.dir") + "\\src\\main\\java\\");
	}
	...
	public void testEncode() {
		System.out
				.println(new String(
						Base64.encodeBase64("jdbc:mysql://mysql.bradypod.com:3306/item_center?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull"
								.getBytes())));
	}
}
