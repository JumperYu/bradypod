...
public class GeneratorProperties {
	...
	static final String PROPERTIES_FILE_NAMES[] = new String[] { "generator.properties",
			"generator.xml", "custom-generator.properties", "custom-generator.xml" };
	...
	public static void reload() {
		try {
			GLogger.println("Start Load GeneratorPropeties from classpath:"
					+ Arrays.toString(PROPERTIES_FILE_NAMES));
