...
/**
 * 服务端会话 Created by oldmanpushcart@gmail.com on 15/5/2.
 */
public class Session {
	 ...
	 *            会话字符集
	 */
	Session(int javaPid, int sessionId, long sessionDuration,
			SocketChannel socketChannel, Charset charset) {
	 ...
	 */
	public void touch() {
		gmtLastTouch = System.currentTimeMillis();
	}
	...
	public boolean isExpired() {
		return sessionDuration <= System.currentTimeMillis() - gmtLastTouch;
	}
	...
	public String prompt() {
		return StringUtils.isNotBlank(getPrompt()) ? "\r" + getPrompt()
				: StringUtils.EMPTY;
	}
